...
/// 4. Added save to png, modified destructor
///    by Yan Naing Aye (19/12/18)
/// Requirements:
...
#if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    if (_pclose(gnucmd) == -1) ;// throw GnuplotException("Problem closing communication to gnuplot");
#elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    if (pclose(gnucmd) == -1) ; // throw GnuplotException("Problem closing communication to gnuplot");
#endif
